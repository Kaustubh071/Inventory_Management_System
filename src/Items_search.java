...
import java.io.*;
import javax.swing.*;
public class Items_search extends javax.swing.JFrame {

    /**
     * Creates new form Items_search
     */
    public Items_search() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Items_search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Items_search().setVisible(true);
            }
        });
    }
