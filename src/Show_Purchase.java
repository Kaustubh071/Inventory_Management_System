...
import java.io.*;
import javax.swing.*;
public class Show_Purchase extends javax.swing.JFrame {

    /**
     * Creates new form Show_Purchase
     */
            ...
            if (jTextField3.getText().equals("")) {
                ...
                if (!(x >= 100)) {
                    ...
                    if (found) {
                        ...
                        JOptionPane.showMessageDialog(null, "Succesfully Added the items!", " Ok!  :-)", JOptionPane.INFORMATION_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Inventory is Full!", "Warning!", JOptionPane.WARNING_MESSAGE);
                }
            }
